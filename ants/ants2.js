const run = function(data){
    ...
    let minMaxEye = [1,5];
    let mapMinMaxX =[110,1000];
    let mapMinMaxY =[300,900];
    ...
    const onClickLeg = function (clickedDataItem, left) {
       let scalaturaX = scaleLeg.range(mapMinMaxX);
       let scalaturaY = scaleLeg.range(mapMinMaxY);
        data = data
            .map(i => {
                   
                    i.horizontalPosition = scalaturaX(i.legLength);
                   // i.verticalPosition = scalaturaY(i.legLength);
    ...
    const onClickBody = function (clickedDataItem, left) {
       let scalaturaX = scaleAddome.range(mapMinMaxX);
       let scalaturaY = scaleAddome.range(mapMinMaxY);
        data = data
            .map(i => {
                    
                    i.horizontalPosition = scalaturaX(i.larghezzaAddome);
                    //i.verticalPosition = scalaturaY(i.larghezzaAddome);
     ...
     const onClickEye = function (clickedDataItem, left) {
        let scalaturaX = scaleEye.range(mapMinMaxX);
        let scalaturaY = scaleEye.range(mapMinMaxY);
        data = data
            .map(i => {
                    
                    i.horizontalPosition = scalaturaX(i.eyeDimension);
                   // i.verticalPosition = scalaturaY(i.eyeDimension);
    ...
    const onClickAntenna = function (clickedDataItem, left) {
        let scalaturaX = scaleAntenna.range(mapMinMaxX);
        let scalaturaY = scaleAntenna.range(mapMinMaxY);
        data = data
            .map(i => {

                    i.horizontalPosition = scalaturaX(i.lunghezzaAntenna);
                    //i.verticalPosition = scalaturaY(i.lunghezzaAntenna);
